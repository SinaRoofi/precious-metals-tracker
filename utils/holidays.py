...
# ⚠️ تعطیلات اضطراری/دستی — برای مواقعی که بازار به دلیلی غیرمنتظره و خارج از
# تقویم رسمی (نه در holidayapi.ir، نه در لیست هاردکد زیر) تعطیل است.
# این لیست بالاترین اولویت را دارد و حتی جمعه/API را هم override می‌کند
# (در عمل برای جمعه بی‌اثره چون جمعه همیشه تعطیله، ولی برای روزهای عادی کاربرد داره).
#
# فرمت: (سال شمسی, ماه, روز) — دستی اضافه/حذف کن.
# مثال: (1405, 5, 10),  # توضیح دلیل تعطیلی رو به‌عنوان کامنت بنویس
