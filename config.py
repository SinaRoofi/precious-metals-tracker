...
# --- نقره ---
SILVER_SHAMS_HIGH = 550_000
SILVER_SHAMS_LOW = 450_000
...
SILVER_YEAR_END_OUNCE_TARGET = 70 
...
# ════════════════════════════════════════════════════════════════
# 🏦 عسکه (سلف امامی بانک مرکزی) — بعد از سررسید (۱۸ آذر ۱۴۰۵) این بلاک،
#    utils/salaf.py و اتصال‌هاش تو main.py و telegram_sender.py رو پاک کن
#    (خودش هم بعد از سررسید غیرفعال می‌شه).
# ════════════════════════════════════════════════════════════════

SALAF_ASSET_URL = "https://rahavard365.com/api/v2/asset/51198"
SALAF_GUARANTEE_PRICE = 252_000_000      # تومان — تضمین خرید بانک مرکزی در سررسید
SALAF_MATURITY_JALALI = (1405, 9, 18)    # سررسید: ۱۸ آذر ۱۴۰۵
SALAF_FEE = 0.00145                      # کارمزد خرید + فروش روی هم
SALAF_PRICE_SCALE = 100                  # real_close_price × 100 = هم‌مقیاس امامی (تومان)
SALAF_AFTER_ASSET_KEY = "سکه-امامی-طرح-جدید"  # خط‌های عسکه درست بعد از این دارایی میان
