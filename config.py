...
# جهانی اونس طلا در پایان سال؛ default فعلاً ۴۶۰۰$، ⚠️ حتماً با پیش‌بینی
# واقعی خودت جایگزینش کن).
# نرخ دلار در این فرمول از همون سه سناریوی بالا خونده می‌شه
# (کران پایین/ارزش دلار/کران بالا — LOW_VALUE/VALUE/HIGH_VALUE)،
# نه از این ثابت.
GOLD_YEAR_END_OUNCE_TARGET = 4600  # $
