...
# --- طلا ---
SHAMS_HIGH = 29_000_000
SHAMS_LOW = 28_000_000
...
# ════════════════════════════════════════════════════════════════
# قیمت اونس هدف — دستی و توسط خودت تنظیم می‌شه (پیش‌بینی خودت از قیمت
# جهانی اونس طلا در پایان سال؛ default فعلاً برابر GOLD_HIGH گذاشته شده،
# ⚠️ حتماً با پیش‌بینی واقعی خودت جایگزینش کن).
# نرخ دلار در این فرمول از همون سه سناریوی موجود در کپشن خونده می‌شه
# (کران پایین/ارزش دلار/کران بالا — LOW_VALUE/VALUE/HIGH_VALUE بالا)،
# نه از این ثابت.
GOLD_YEAR_END_OUNCE_TARGET = GOLD_HIGH  # $
